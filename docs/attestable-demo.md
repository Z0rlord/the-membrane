# Attestable local demo

Browser dashboard for the Attestable fail-closed narrative, backed by real Membrane gate IAC checks and CP receipt chaining.
...
Optional listen address: `cargo run -p membrane-cli -- attestable --listen 127.0.0.1:8790`
...
Attestable enforces and proves traffic routed through the gateway. This demo does not claim hidden reasoning, deletion, off-gateway coverage, or compliance guarantees.
