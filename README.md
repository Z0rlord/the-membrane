...
> **Independent research.** Personal work by [Zorie R. Barber](https://github.com/Z0rlord). **Not affiliated with any company, employer, university, or organization.** Third-party names (Neuralink, OpenBCI, etc.) appear for technical comparison only — no endorsement or partnership implied.
...
| File | Description |
|------|-------------|
| [docs/whitepaper.md](docs/whitepaper.md) | Full specification (v0.9.5) |
